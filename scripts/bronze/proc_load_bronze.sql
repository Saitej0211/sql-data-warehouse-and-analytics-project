...
CREATE OR REPLACE PROCEDURE bronze.load_bronze(crm_path TEXT, erp_path TEXT)
LANGUAGE plpgsql
AS $$
DECLARE
...
BEGIN
    ...
    RAISE NOTICE '==============================================';
	RAISE NOTICE '>> Total Bronze Layer Load Duration: % seconds', batch_load_time;
...
CALL bronze.load_bronze('/source_crm', '/source_erp');
